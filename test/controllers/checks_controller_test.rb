...
class ChecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create check" do
    assert_difference('Check.count') do
      post checks_url, params: { check: { checkin: @check.checkin, checkout: @check.checkout, days: @check.days } }
    end
  ...
  test "should update check" do
    patch check_url(@check), params: { check: { checkin: @check.checkin, checkout: @check.checkout, days: @check.days } }
